...
import { InvitationWelcomePayload } from '../types.js';
...
export function InvitationWelcomeEmail({ firstName, orgName, role, appUrl }: InvitationWelcomePayload) {
      ...
      <Body style={body}>
        <Container style={container}>
          ...
          <Text style={text}>
            ...
            <strong>{roleLabel}</strong>. Ingresa a la aplicación para comenzar a colaborar.
          </Text>
          <Section style={btnSection}>
            <Button style={button} href={appUrl}>Ir a la aplicación</Button>
          </Section>
          <Hr style={hr} />
...
const button: React.CSSProperties = { backgroundColor: '#4f46e5', borderRadius: '6px', color: '#ffffff', display: 'inline-block', fontSize: '14px', fontWeight: '600', padding: '12px 24px', textDecoration: 'none' };
